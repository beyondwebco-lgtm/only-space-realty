...
export default function PropertiesPage() {
  ...
  const featuredSchemes = [
    ...
    },
    {
      ...
      highlights: ["Shilaj Circle near SBR", "Spacious 2 & 3 BHK Layouts", "Modern Architectural Elevation"],
      description: "Sheladia Divine offers thoughtfully designed 2 & 3 BHK residential apartments located at Shilaj Circle near Sindhu Bhavan Road, Ahmedabad West. Features triple high-rise towers, premium lifestyle amenities, serene landscaped surroundings, and seamless connectivity.",
    },
    {
      id: "ashray-aurum",
      name: "Ashray Aurum",
