...
export default function GalleryPage() {
  ...
  const galleryItems = [
    ...
    },
    {
      ...
      location: "Shilaj Circle, Ahmedabad West",
      desc: "2 & 3 BHK residential apartments located at Shilaj Circle, Ahmedabad West featuring modern triple high-rise towers, lifestyle amenities, and prime connectivity.",
    },
  ];
