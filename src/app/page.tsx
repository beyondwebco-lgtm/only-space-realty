...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-transparent text-neutral-100 font-sans overflow-x-hidden">
      ...
      {/* ONLY SPACE REALTY Strategic Consultancy Showcase */}
      <section className="py-24 px-6 md:px-12 bg-[#0C0C0C]/80 border-t border-neutral-900 relative z-10">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
            ...
            <div className="lg:col-span-6 bg-[#141414] border border-gold/30 rounded-3xl p-8 md:p-10 flex flex-col justify-between shadow-2xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-48 h-48 bg-gold/5 rounded-full blur-3xl group-hover:bg-gold/10 transition-all duration-500" />
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="space-y-4 font-sans text-xs tracking-wider text-neutral-300 leading-relaxed">
                  <p>
                    <strong className="text-white">Nature of Business:</strong> Real Estate Consultancy & Property Management Company.
                  </p>
                  <p>
                    <strong className="text-white font-serif text-sm block mb-1">About the Firm:</strong>
                    ONLY SPACE REALTY is an accomplished real estate firm dealing in the <strong className="text-white">&quot;Ahmedabad-West&quot;</strong> locality. Drawing from years of experience, we bring a strategic yet personal approach to buying, selling, and renting homes.
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 py-1">
                    <div className="bg-[#1A1A1A] p-2.5 rounded-xl border border-gold/30 text-center">
                      <span className="text-[10px] text-white font-bold block uppercase tracking-wider">Transparent Dealings</span>
                    </div>
                    <div className="bg-[#1A1A1A] p-2.5 rounded-xl border border-gold/30 text-center">
                      <span className="text-[10px] text-white font-bold block uppercase tracking-wider">Reliable Services</span>
                    </div>
                    <div className="bg-[#1A1A1A] p-2.5 rounded-xl border border-gold/30 text-center">
                      <span className="text-[10px] text-white font-bold block uppercase tracking-wider">Believe in Commitment</span>
                    </div>
                  </div>
                  <div className="pt-2 border-t border-neutral-800 space-y-2">
                    <span className="font-serif text-[11px] text-gold uppercase tracking-wider font-bold block">
                      Trusted By Corporate Clients & Executives:
                    </span>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center text-[10px]">
                      <div className="bg-[#1A1A1A] p-2 rounded-lg border border-gold/30 text-white font-bold">
                        Torrent Pharma
                      </div>
                      <div className="bg-[#1A1A1A] p-2 rounded-lg border border-gold/30 text-white font-bold">
                        Taj Skyline
                    ...
                    <span className="text-[10px] text-grey italic block pt-0.5">...and many more corporate clients across Shilaj & Sindhu Bhavan Area.</span>
                  </div>
                  <div className="flex items-start gap-3 bg-[#1A1A1A] p-3.5 rounded-2xl border border-neutral-800 text-grey text-[11px]">
              ...
              <div className="pt-8 border-t border-neutral-800 flex flex-wrap gap-4 items-center justify-between font-sans text-[10px] uppercase tracking-widest text-grey relative z-10">
                <div className="flex items-center gap-2">
                  <Shield className="h-4 w-4 text-gold" /> Certified Property Advisory
                </div>
                <div className="flex items-center gap-2">
                  <Award className="h-4 w-4 text-gold" /> 8+ Years Corporate Trust
                </div>
              </div>
            </div>

            {/* Founder Spotlight Card */}
            <div className="lg:col-span-6 bg-[#141414] border border-gold/30 rounded-3xl p-8 md:p-10 flex flex-col justify-between shadow-2xl relative overflow-hidden">
              <div className="space-y-6 relative z-10">
                <span className="font-sans text-[10px] tracking-[0.25em] text-gold uppercase block font-bold">
                  Founder Spotlight
                </span>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 border-b border-neutral-800 pb-6">
                  ...
                  <div className="space-y-1">
                    <span className="inline-block px-2.5 py-0.5 rounded-full bg-gold/10 border border-gold/30 text-gold text-[9px] font-bold uppercase tracking-wider">
                      Leadership & Vision
                    </span>
                    <h3 className="font-serif text-2xl text-white font-bold tracking-wide">Dhrumit Darji</h3>
                    <p className="font-sans text-xs text-gold uppercase tracking-wider font-semibold">Founder & Chief Real Estate Consultant</p>
                    <p className="font-sans text-[10px] text-neutral-400">ONLY SPACE REALTY • Ahmedabad West</p>
                  </div>
                </div>
