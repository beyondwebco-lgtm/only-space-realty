...
const RECOMMENDATION_DATABASE: Record<string, Recommendation> = {
  ...
  "RESIDENTIAL_SHILAJ_END_USE": {
    ...
    locationBadge: "Shilaj Circle Area",
    schemes: ["Kaveri Soham Vivanta (Shilaj)", "Kaveri Trisara (Shilaj Area)", "Sharnya Altura (Shilaj Corridor)"],
    priceRange: "₹1.50 Cr – ₹4.80 Cr+",
  ...
  "RESIDENTIAL_SHILAJ_CORPORATE": {
    ...
    schemes: ["Kaveri Soham Vivanta (Executive Units)", "Sharnya Altura (Duplex Suites)", "Kaveri Trisara (Luxury Wing)"],
    priceRange: "₹1.80 Cr – ₹5.20 Cr+",
  ...
  "RESIDENTIAL_SHILAJ_INVESTMENT": {
    ...
    schemes: ["Kaveri Soham Vivanta", "Kaveri Trisara", "Ashray Aurum (Residential Sector)"],
    priceRange: "₹1.50 Cr – ₹6.50 Cr+",
  ...
  "RESIDENTIAL_SBR_INVESTMENT": {
    ...
    schemes: ["Sharnya Altura (Luxury Tower)", "Kaveri Trisara (High Floor)", "Kaveri Soham Vivanta"],
    priceRange: "₹2.20 Cr – ₹7.50 Cr+",
  ...
  "RESIDENTIAL_BODAKDEV_END_USE": {
    ...
    schemes: ["Sharnya Altura (Bodakdev Sector)", "Kaveri Trisara", "Shilp One (Luxury Sector)"],
    priceRange: "₹2.00 Cr – ₹6.80 Cr+",
  ...
  "RESIDENTIAL_BODAKDEV_INVESTMENT": {
    ...
    schemes: ["Kaveri Trisara (Bodakdev Belt)", "Sharnya Altura", "Kaveri Soham Vivanta"],
    priceRange: "₹1.90 Cr – ₹6.20 Cr+",
    expectedYield: "7.2% – 8.8% Annual ROI",
  },

  // Commercial
  "COMMERCIAL_SHILAJ_END_USE": {
    category: "Shilaj Circle Commercial Showrooms & Offices",
    locationBadge: "Shilaj Circle Area",
    schemes: ["Ashray Aurum (Near Shilaj Circle)", "Shilp One (Shilaj Extension)", "Kaveri Soham Commercial Wing"],
    priceRange: "₹1.10 Cr – ₹4.50 Cr+",
    expectedYield: "7.0% – 8.8% Expected Rental Yield",
  },
  "COMMERCIAL_SHILAJ_CORPORATE": {
    category: "Shilaj Circle Corporate Towers & Tech Offices",
    locationBadge: "Shilaj Hub",
    schemes: ["Ashray Aurum (Commercial Tower)", "Shilp One (Shilaj Corridor)", "Kaveri Trisara Commercial"],
    priceRange: "₹1.50 Cr – ₹6.20 Cr+",
    expectedYield: "7.8% – 9.2% Pre-Leased Yield",
  },
  "COMMERCIAL_SHILAJ_INVESTMENT": {
    category: "Shilaj Commercial High-Yield Showrooms",
    locationBadge: "Shilaj Circle Growth Belt",
    schemes: ["Ashray Aurum (Retail Showrooms)", "Shilp One Commercial", "Kaveri Soham Retail"],
    priceRange: "₹1.25 Cr – ₹5.80 Cr+",
  ...
  "COMMERCIAL_SBR_INVESTMENT": {
    ...
    priceRange: "₹2.20 Cr – ₹14.00 Cr+",
    expectedYield: "9.0% – 11.5% Corporate Yield",
  },
  "COMMERCIAL_BODAKDEV_END_USE": {
    category: "Bodakdev & SG Highway Business Outlets",
    locationBadge: "Bodakdev & SG Highway",
    schemes: ["Shilp One (Bodakdev Sector)", "Ashray Aurum (SG Highway Belt)", "Kaveri Trisara Retail"],
    priceRange: "₹1.80 Cr – ₹8.50 Cr+",
  ...
  "COMMERCIAL_BODAKDEV_INVESTMENT": {
    ...
    priceRange: "₹1.90 Cr – ₹9.20 Cr+",
    expectedYield: "8.8% – 10.8% Rental Yield",
  },

  // Plot / Land
  "PLOT_SHILAJ_END_USE": {
    category: "Shilaj Circle Residential Plot Parcels for Villas",
    locationBadge: "Shilaj Circle Area",
    schemes: ["Prime Shilaj Circle Plot Parcels", "Shilaj Extension Villa Land", "Ambli-Shilaj Private Estates"],
    priceRange: "₹3.50 Cr – ₹15.00 Cr+",
    expectedYield: "12% – 15% Land Value Growth",
  },
  "PLOT_SHILAJ_CORPORATE": {
    category: "Shilaj Commercial Land Parcels for Tech Parks",
    locationBadge: "Shilaj Growth Belt",
    schemes: ["Shilaj Circle Commercial Plot Parcels", "Ambli-Shilaj Land Ring", "Shilaj Outer Ring Parcels"],
    priceRange: "₹5.00 Cr – ₹25.00 Cr+",
    expectedYield: "14% – 18% Land Value Growth",
  },
  "PLOT_SHILAJ_INVESTMENT": {
    category: "Shilaj High-ROI Land Investments",
    locationBadge: "Shilaj Growth Belt",
    schemes: ["Prime Shilaj Circle Plot Parcels", "Bopal-Shilaj Outer Ring Parcels", "Ambli Land Extensions"],
    priceRange: "₹3.80 Cr – ₹20.00 Cr+",
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  { id: "RESIDENTIAL" as SectorType, label: "Residential", sub: "3, 4 & 5 BHK Estates", icon: Home },
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  { id: "SHILAJ" as CorridorType, name: "Shilaj Circle Area", detail: "Luxury Living & Land" },
